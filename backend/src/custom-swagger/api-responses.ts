...
export function ApiResponseFindCalendarOrArchiveCelendarById(
  options?: object,
): MethodDecorator {
  return ApiResponse(
    options || {
...
export function ApiResponseUpdateCelendarById(
  options?: object,
): MethodDecorator {
  return ApiResponse(
    options || {
...
export function ApiResponseDeleteCalendarOrArchiveCalendar(
  options?: object,
): MethodDecorator {
  return ApiResponse(
    options || {
